...
export const impersonatePending = 'impersonatePending';
export const impersonateFailure = 'impersonateFailure';
export const impersonateSuccess = 'impersonateSuccess';
